...
namespace RegistrationAndLogin
{
    public partial class Login : Form
    {
        ...
        {
            cn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Visual Studio Projects\QR-code\RegistrationAndLogin\Database.mdf;Integrated Security=True");
            cn.Open();
        }
